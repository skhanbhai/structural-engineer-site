...
(function () {
  ...
  function injectFloatingButton() {
    ...
    // FAB is a <button> so the click can't navigate before the enquiry modal
    // opens. data-whatsapp-modal-trigger is picked up by the shared document
    // delegate in whatsapp-form.js, which opens the modal, validates the
    // logged enquiry, then opens wa.me with the prefilled message.
    var b = document.createElement('button');
    b.type = 'button';
    b.className = 'whatsapp-fab';
    b.setAttribute('aria-label', 'Open WhatsApp enquiry form');
    b.setAttribute('aria-haspopup', 'dialog');
    b.setAttribute('aria-controls', 'waModal');
    b.setAttribute('data-whatsapp-modal-trigger', 'floating');
